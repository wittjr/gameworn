"""
2020-21 NHL population report (COVID-shortened 56-game divisional season).
...
def parse_tags_2020(wb, actual, manifest, report):
    return toolbox.read_tag_rows(wb, actual, manifest, report)


def parse_schedule_2020(wb, actual, manifest, report, tag_teams):
    return toolbox.read_combined_schedule(
        wb, actual, 'SET DATES - JERSEY SCHEDULES', report.season, tag_teams)


register('NHL', '2020-21', YearSpec(MANIFEST_2020, parse_tags_2020, parse_schedule_2020))
